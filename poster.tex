...
\author{Ferdynand Sikora \and Krystyna Supińska \faEnvelope}
\email{123456@student.pwr.edu.pl}
\institute{\href{https://kssk.pwr.edu.pl}{Katedra Stystemów i Sieci Komputerowych}}
...
\begin{column}{\colwidth}
  ...
  \end{alertblock}
    ...
    \begin{figure}
      \centering
        \includegraphics[scale=0.32]{figures/fig2}
